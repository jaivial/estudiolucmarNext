            ...
            <div className='h-auto w-full'>
                {data.inmueble.encargostate && data.inmueble.encargostate === true ? (
                    <>
                        {
                            encargoData?.tipo_encargo === 'Venta' && (
                                <div className='flex flex-row gap-1 items-center'>
                                    <Icon icon="codicon:circle-filled" className='text-green-500 text-xl' />
                                    <p className='text-green-500 text-xl'>En venta</p>
                                </div>
                            )
                        }
                        {
                            encargoData?.tipo_encargo === 'Alquiler' && (
                                <div className='flex flex-row gap-1 items-center'>
                                    <Icon icon="codicon:circle-filled" className='text-green-500 text-xl' />
                                    <p className='text-green-500 text-xl'>En alquiler</p>
                                </div>
                            )
                        }
                        {
                            !encargoData && (
                                <div className='flex flex-row gap-1 items-center'>
                                    <Icon icon="codicon:circle-filled" className='text-red-500 text-xl' />
                                    <p className='text-red-500 text-xl'>No hay encargo</p>
                                </div>
                            )
                        }
                    </>
                    ...
                    <>
                        <div className='flex flex-row gap-1 items-center'>
                            <Icon icon="codicon:circle-filled" className='text-red-500 text-xl' />
                            <p className='text-red-500 text-xl'>Sin actividad</p>
                        </div>
                    </>
                )}
            </div>
