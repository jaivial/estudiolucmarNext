        ...
        <div className="flex flex-col gap-4 p-2">
            ...
            <AnimatePresence>
                {showMoreFilters && (
                    ...
                    >
                        <MoreFilters filters={filters} setFilters={setFilters} resetFiltersKey={resetFiltersKey} screenWidth={screenWidth} />
                    </motion.div>
                )}
            </AnimatePresence>

            <div className={`${screenWidth >= 1280 ? 'flex flex-row gap-2 w-[100%]' : 'flex flex-col gap-4 w-full'} items-center justify-center orderbyanimation z-[990]`}>

                <div className={`flex flex-row gap-2 ${screenWidth >= 1280 ? 'w-[100%]' : 'w-full'} items-center justify-center orderbyanimation z-[990]`}>
                    <Select
                ...
                <div className={`flex flex-row gap-2 ${screenWidth >= 1280 ? 'w-[100%]' : 'w-full'}  items-center justify-center z-[980]`}>
                    {/* Zone Select */}
                    <Select
                        options={zoneOptions}
                ...
                <Select
                    ...
                    placeholder="DPV"
                    className={`rightanimation2 ${screenWidth >= 1280 ? 'w-[50%]' : 'w-full'}  z-[966]`}
                />
            </div>
            {/* Superficie Range */}
            <div className={`${screenWidth >= 1280 ? 'flex flex-row gap-4' : 'flex flex-col gap-4'}`}>
                <div className={`slideranimation1 flex flex-col py-3 px-4 ${screenWidth >= 1280 ? 'w-[50%]' : 'w-full'}  justify-center items-center bg-white border border-gray-300 rounded-lg shadow-md z-[960]`}>
                ...
                {/* Year Range */}
                <div className={`flex flex-col py-3 px-4 ${screenWidth >= 1280 ? 'w-[50%]' : 'w-full'} justify-center items-center bg-white border border-gray-300 rounded-lg shadow-md slideranimation2`}>
