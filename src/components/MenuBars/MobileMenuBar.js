        ...
        <div id="completesidenavbar" className="relative z-[999]">
            <nav className="h-9 w-full flex flex-row justify-between bg-white border-t shadow-xl fixed bottom-0 left-0 z-[999] overflow-visible">
                <ul className="w-full h-full flex flex-row justify-around items-end transition-all ml-3 pb-2 overflow-y-visible shadow-xl">
                    <a href="/home" id="mobile-itemHome" className="h-[55px] bg-blue-400 p-2.5 px-3.5 rounded-3xl shadow-lg text-white flex items-center justify-center hover:cursor-pointer hover:bg-blue-400 hover:text-white">
                    ...
                    <a href="/buscador" id="mobile-itemBuscador" className="h-[45px] bg-white p-2 px-3.5 rounded-3xl shadow-lg flex items-center justify-center hover:cursor-pointer hover:bg-blue-400 hover:text-white">
                    ...
                    <a href="/mapa" id="mobile-itemMapa" className="h-[45px] bg-white p-2 px-3.5 rounded-3xl shadow-lg flex items-center justify-center hover:cursor-pointer hover:bg-blue-400 hover:text-white">
                    ...
                    <div id="moreMobileMenu" className="h-auto pt-3.5 px-3.5 rounded-3xl flex flex-col items-center justify-center">
                        <ul className="w-auto h-full flex flex-col justify-between gap-6">
                            <a id="mobile-itemEncargos" className="h-[45px] bg-white p-2 px-3.5 rounded-3xl shadow-lg hidden items-center justify-center hover:cursor-pointer hover:bg-blue-400 hover:text-white">
                            ...
                            <a id="mobile-itemNoticias" className="hidden h-[45px] bg-white p-2 px-3.5 rounded-3xl shadow-lg items-center justify-center hover:cursor-pointer hover:bg-blue-400 hover:text-white">
                            ...
                            <a href="/settings" id="mobile-itemSettings" className="h-[45px] bg-white p-2 px-3.5 rounded-3xl shadow-lg hidden items-center justify-center hover:cursor-pointer hover:bg-blue-400 hover:text-white">
                            ...
                            <a id="mobile-itemLogOut" className="h-[45px] bg-white p-2 px-3.5 rounded-3xl shadow-lg hidden items-center justify-center hover:cursor-pointer hover:bg-blue-400 hover:text-white" onClick={handleLogout}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="1.8em" height="1.8em" viewBox="0 0 24 24">
                            ...
                            <a id="mobile-itemMoreMenuIcon" className="h-[45px] bg-white p-2 px-3.5 rounded-3xl shadow-lg flex items-center justify-center hover:cursor-pointer hover:bg-blue-400 hover:text-white" onClick={toggleDesplegarMoreMenu}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="1.8em" height="1.8em" viewBox="0 0 24 24">
