...
const MobileMenuBar = () => {
    ...
    const isActive = (page) => currentPage === page ? 'h-[55px] bg-blue-400 p-2.5 text-white' : 'h-[45px] bg-white p-2 text-black';
        ...
        <div id="completesidenavbar" className="relative z-[9999]">
            <nav className="h-10 w-full flex flex-row justify-between border-t border-slate-300 shadow-2xl fixed bottom-0 left-0 z-[9999] overflow-visible bg-slate-50">
                <ul className="w-full h-full flex flex-row justify-around items-end transition-all pb-3.5 overflow-y-visible shadow-xl">
                    ...
                    <Link href="/buscador" className={`${isActive('Buscador')} px-3.5 rounded-3xl shadow-lg flex items-center justify-center`}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="1.8em" height="1.8em" viewBox="0 0 14 14">
                            <path fill="currentColor" fillRule="evenodd" d="M2 6a4 4 0 1 1 8 0a4 4 0 0 1-8 0m4-6a6 6 0 1 0 3.476 10.89l2.817 2.817a1 1 0 0 0 1.414-1.414l-2.816-2.816A6 6 0 0 0 6 0" clipRule="evenodd"></path>
                        </svg>
                    </Link>
                    <Link href="/mapa" className={`${isActive('Mapa')} px-3.5 rounded-3xl shadow-lg flex items-center justify-center`}>
