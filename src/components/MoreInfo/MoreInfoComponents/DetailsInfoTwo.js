...
const DetailsInfoTwo = ({ data, descripcion, setDescripcion, newDescripcion, setNewDescripcion, screenWidth }) => {
    ...
    return (
        <div className={`${screenWidth >= 640 ? 'pl-0 pr-0' : 'p-4'} w-full flex justify-center flex-col`}>
            {descripcion !== '' && descripcion !== null ? (
                ...
                <>
                    ...
                    <button onClick={handleSaveClick} className="bg-blue-500 text-white px-4 py-2 mx-auto mt-2 rounded-md">
                        Enviar
                    </button>
